...
<meta name='yandex-verification' content='ff28d9577869259f' />
...
$(document).ready(function(){
	...
	var frs = $('.fotorama');
	frs.each(function(index){
		
		var fr = $(this);
		fr.wrap('<div class="_azbn-fotorama-cont" style="max-width:' + (_w * 0.75) + 'px;" ></div>');
...
.azbn-content ul, .azbn-content ol {
	margin-left:0;
}
.azbn-content ul li, .azbn-content ol li {
	text-overflow:ellipsis;
	display:block;
}
.azbn-content ul li a, .azbn-content ol li a{
	display:inline-block;
	max-width:90%;
...
@media (max-width: 767px) {
	.social-block-material {
		margin-top:100px;
	}
	.azbn-content .contact-cont .subscribe .items input[type=submit] {
		margin:1.4em 0;
		display:inline-block;
	}
	.azbn-content {
...
<link  href="<?=$this->path('css');?>/../import/fotorama/fotorama.css" rel="stylesheet"> <!-- 3 KB -->
<script src="<?=$this->path('css');?>/../import/fotorama/fotorama.js"></script> <!-- 16 KB -->