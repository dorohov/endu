...
$(function(){var e,t=$(".b-azbn-diy-selfibot-container").eq(0),n=function(t){t?setTimeout(function(){e=!1},t):e=!1};n(),!t.size()||device.mobile()||device.tablet()||($(document.body).on("azbn.wheel",".b-azbn-diy-selfibot-container",{},function(e,t){e.preventDefault();var n=t.callback;n()}),$(document).on("wheel mousewheel DOMMouseScroll",function(a){if(a.preventDefault(),!e){e=!0;var i,l=a.originalEvent.wheelDelta,o=parseInt(t.attr("data-slide-id"));l>0?o>0?(i=o-1,t.attr("data-slide-id",i),t.trigger("azbn.wheel",[{diff:l,next:i,callback:function(){n(300)}}])):n():0>l&&9>o?(i=o+1,t.attr("data-slide-id",i),t.trigger("azbn.wheel",[{diff:l,next:i,callback:function(){n(300)}}])):n()}}))});
