...
$(function(){var e,t=$(".b-azbn-diy-selfibot-container").eq(0),n=function(t){t?setTimeout(function(){e=!1},t):e=!1};n();var a=t.find(".fullscreen-content .b-azbn-slide").size();if(a){var i=t.find(".fullscreen-content .content-pagination ul");i.empty(),t.find(".fullscreen-content .b-azbn-slide").each(function(e){var a=$(this),l=a.attr("data-slide-id");i.append('<li><a href="#-" data-slide-id="'+l+'" ></a></li>'),i.find("li a").on("click.azbn",function(e){e.preventDefault();var a=$(this),i=parseInt(a.attr("data-slide-id"));t.attr("data-slide-id",i),t.trigger("azbn.wheel",[{diff:0,next:i,callback:function(){n(451)}}])})}),$("#b-azbn-diy-selfibot-container-slide-count").html(a)}!t.size()||device.mobile()||device.tablet()||($(document.body).on("azbn.wheel",".b-azbn-diy-selfibot-container",{},function(e,t){e.preventDefault();var n=t.callback;9!=t.next&&1!=t.next&&$("#b-azbn-diy-selfibot-container-slide-id").html(t.next-1),n()}),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .down-scroll-btn a",{},function(e){e.preventDefault();var a=parseInt(t.attr("data-slide-id")),i=a+1;t.attr("data-slide-id",i),t.trigger("azbn.wheel",[{diff:0,next:i,callback:function(){n(451)}}])}),$(document).on("wheel mousewheel DOMMouseScroll",function(a){if(a.preventDefault(),!e){e=!0;var i,l=a.originalEvent.wheelDelta,d=parseInt(t.attr("data-slide-id"));l>0?d>0?(i=d-1,t.attr("data-slide-id",i),t.trigger("azbn.wheel",[{diff:l,next:i,callback:function(){n(451)}}])):n():0>l&&9>d?(i=d+1,t.attr("data-slide-id",i),t.trigger("azbn.wheel",[{diff:l,next:i,callback:function(){n(451)}}])):n()}}))});
