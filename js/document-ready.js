...
$(function(){$(".bottom-bordered .bb-help").tooltip(),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .youtube-btn",{},function(o){o.preventDefault();var t=$(this),e=t.attr("data-youtube-uid");$(".b-azbn-modal-block .youtube-modal-video").attr("src","https://www.youtube.com/embed/"+e)}),$.okvideo({target:$('.b-azbn-diy-selfibot-container .b-azbn-slide[data-slide-id="1"]'),video:$('.b-azbn-diy-selfibot-container .b-azbn-slide[data-slide-id="1"]').attr("data-okvideo-uid"),volume:100,hd:!0,disablekeyControl:!0,captions:!1,loop:!0,controls:!1})});
