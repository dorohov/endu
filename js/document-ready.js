...
$(function(){var e=$(".b-azbn-diy-selfibot-container").eq(0);if(e.size()){var t=e.find('.fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-iphone'),n=e.find('.fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-selfibot');$(document.body).on("azbn.setActive",'.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-iphone .iphone-screen',{},function(e){e.preventDefault();var n=$(this);n.addClass("active");var i=n.next(".iphone-screen");i.size()?$('.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-iphone-cont .congrat-blurscreen').attr("style",i.attr("style")):$('.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-iphone-cont .congrat-blurscreen').attr("style",t.find(".iphone-screen").eq(0).attr("style"))}),$(document.body).on("azbn.setActive",'.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-selfibot .selfibot-screen',{},function(e){e.preventDefault();var t=$(this);t.addClass("active");var i=t.next(".selfibot-screen");i.size()?$('.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-selfibot-cont .congrat-blurscreen').attr("style",i.attr("style")):$('.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-selfibot-cont .congrat-blurscreen').attr("style",n.find(".selfibot-screen").eq(0).attr("style"))}),$(document.body).on("click",'.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-arrow',{},function(e){e.preventDefault();var n=t.find(".iphone-screen"),i=n.filter(".active");if(i.size()){var a=i.next(".iphone-screen");a.size()?(n.removeClass("active"),a.trigger("azbn.setActive")):(n.removeClass("active"),n.eq(0).trigger("azbn.setActive"))}else n.eq(0).trigger("azbn.setActive")}),$('.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-arrow').trigger("click"),$(document.body).on("click",'.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-arrow2',{},function(e){e.preventDefault();var t=n.find(".selfibot-screen"),i=t.filter(".active");if(i.size()){var a=i.next(".selfibot-screen");a.size()?(t.removeClass("active"),a.trigger("azbn.setActive")):(t.removeClass("active"),t.eq(0).trigger("azbn.setActive"))}else t.eq(0).trigger("azbn.setActive")}),$('.b-azbn-diy-selfibot-container .fullscreen-content .b-azbn-slide[data-slide-id="8"] .congrat-arrow2').trigger("click")}});
$("._czr__dropdown-btn").on("click",function(){$(this).parent().toggleClass("open")});
$(".b-video-cont").each(function(t){var e=$(this),i=e.find(".list .item");i.on("click",function(t){t.preventDefault();var i=$(this),c=i.attr("href").slice(1);e.find(".player iframe").attr("src","https://www.youtube.com/embed/"+c)})});
...
var h_window=$(window).height(),w_window=$(window).width(),h_navbar=$(".b-top-menu").outerHeight(!0),h_header=$(".b-top-header").outerHeight(!0),h_footer=$(".b-bottom-footer").outerHeight(!0),h_content=h_window-h_navbar-h_footer;device.mobile()?$(".content-block__text").removeAttr("style"):$(".content-block__text").css("min-height",h_content);
...
$(window).on('scroll',function(){
	...
	$(function(){var a=$(document).scrollTop(),o=$(".goto-top");o.hasClass("active")?a<450&&o.removeClass("active"):a>450&&o.addClass("active")});
