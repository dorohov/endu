...
$(function(){$(".bottom-bordered .bb-help").tooltip(),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .youtube-btn",{},function(t){t.preventDefault();var o=$(this),e=o.attr("data-youtube-uid");$(".b-azbn-modal-block .youtube-modal-video").attr("src","https://www.youtube.com/embed/"+e)}),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .youtube-btn2",{},function(t){t.preventDefault();var o=$(this),e=o.attr("data-youtube-uid");$(".b-azbn-modal-block .youtube-modal-video").attr("src","https://www.youtube.com/embed/"+e)}),$(document.body).on("click.azbn",".bottom-bordered-mobile-btn",{},function(t){t.preventDefault();var o=$(this),e=o.parent(),n=e.find(".bottom-bordered");n.fadeToggle("fast"),o.toggleClass("active")}),$(".bottom-bordered-mobile-btn").trigger("click.azbn"),$(document.body).on("click.azbn",".menu-list-mobile-btn",{},function(t){t.preventDefault();var o=$(this),e=o.parent(),n=e.find("ul");n.fadeToggle("fast"),o.toggleClass("active")}),$(".menu-list-mobile-btn").trigger("click.azbn")}),$(function(){if($(".b-azbn-diy-selfibot-container").size()){var t=$('.b-azbn-diy-selfibot-container .b-azbn-slide[data-slide-id="1"]'),o={target:t,video:t.attr("data-okvideo-uid"),volume:100,hd:!0,disablekeyControl:!0,captions:!1,loop:!1,controls:!1,annotations:!1};(screenJS.isXS()||screenJS.isSM())&&(o.hd=!1)}}),$(function(){$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .content-menu",{},function(t){t.preventDefault(),$(".b-azbn-diy-selfibot-container .content-menu-cont").toggleClass("active"),$(".b-azbn-diy-selfibot-container .down-scroll-btn").toggle()})});
...
$(function(){$("html").hasClass("desktop")&&$(window).outerHeight(!0)<768&&$(window).outerWidth(!0)/$(window).outerHeight(!0)>1.85?$("body").hasClass("xs-h")||$("body").addClass("xs-h"):$("body").removeClass("xs-h")});
