...
$(function(){$(".bottom-bordered .bb-help").tooltip(),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .youtube-btn",{},function(t){t.preventDefault();var o=$(this),n=o.attr("data-youtube-uid");$(".b-azbn-modal-block .youtube-modal-video").attr("src","https://www.youtube.com/embed/"+n)}),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .youtube-btn2",{},function(t){t.preventDefault();var o=$(this),n=o.attr("data-youtube-uid");$(".b-azbn-modal-block .youtube-modal-video").attr("src","https://www.youtube.com/embed/"+n)})}),$(function(){if($(".b-azbn-diy-selfibot-container").size()){var t=$('.b-azbn-diy-selfibot-container .b-azbn-slide[data-slide-id="1"]'),o={target:t,video:t.attr("data-okvideo-uid"),volume:100,hd:!0,disablekeyControl:!0,captions:!1,loop:!1,controls:!1,annotations:!1};(screenJS.isXS()||screenJS.isSM())&&(o.hd=!1)}}),$(function(){$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .content-menu",{},function(t){t.preventDefault(),$(".b-azbn-diy-selfibot-container .content-menu-cont").toggleClass("active"),$(".b-azbn-diy-selfibot-container .down-scroll-btn").toggle()})});
