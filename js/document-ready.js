...
$(function(){$(".bottom-bordered .bb-help").tooltip(),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .youtube-btn",{},function(o){o.preventDefault();var t=$(this),e=t.attr("data-youtube-uid");$(".b-azbn-modal-block .youtube-modal-video").attr("src","https://www.youtube.com/embed/"+e)}),!$(".b-azbn-diy-selfibot-container").size()||screenJS.isXS()||screenJS.isSM()||$.okvideo({target:$('.b-azbn-diy-selfibot-container .b-azbn-slide[data-slide-id="1"]'),video:$('.b-azbn-diy-selfibot-container .b-azbn-slide[data-slide-id="1"]').attr("data-okvideo-uid"),volume:100,hd:!0,disablekeyControl:!0,captions:!1,loop:!0,controls:!1})});
$(function(){var e,t=$(".b-azbn-diy-selfibot-container").eq(0),n=function(t){t?setTimeout(function(){e=!1},t):e=!1};n();var i=t.find(".fullscreen-content .b-azbn-slide").size();if(i&&!screenJS.isXS()&&!screenJS.isSM()){t.css({top:$(".b-top-header").outerHeight(!0)+$(".b-top-menu").outerHeight(!0)+"px"});var a=t.find(".fullscreen-content .content-pagination ul");a.empty(),t.find(".fullscreen-content .b-azbn-slide").each(function(e){var i=$(this),l=i.attr("data-slide-id");a.append('<li><a href="#-" data-slide-id="'+l+'" ></a></li>'),a.find("li a").on("click.azbn",function(e){e.preventDefault();var i=$(this),a=parseInt(i.attr("data-slide-id"));t.attr("data-slide-id",a),t.trigger("azbn.wheel",[{diff:0,next:a,callback:function(){n(451)}}])})}),$("#b-azbn-diy-selfibot-container-slide-count").html(i)}!t.size()||screenJS.isXS()||screenJS.isSM()||($(document.body).on("azbn.wheel",".b-azbn-diy-selfibot-container",{},function(e,t){e.preventDefault();var n=t.callback;9!=t.next&&1!=t.next&&$("#b-azbn-diy-selfibot-container-slide-id").html(t.next-1),0==t.next||1==t.next,n()}),$(document.body).on("click.azbn",".b-azbn-diy-selfibot-container .down-scroll-btn a",{},function(e){e.preventDefault();var i=parseInt(t.attr("data-slide-id")),a=i+1;t.attr("data-slide-id",a),t.trigger("azbn.wheel",[{diff:0,next:a,callback:function(){n(451)}}])}),$(document.body).on("wheel mousewheel DOMMouseScroll MozMousePixelScroll",function(i){if(i.preventDefault(),!e){e=!0;var a,l=-i.originalEvent.deltaY||i.originalEvent.detail||i.originalEvent.wheelDelta,d=parseInt(t.attr("data-slide-id"));l>0?d>0?(a=d-1,t.attr("data-slide-id",a),t.trigger("azbn.wheel",[{diff:l,next:a,callback:function(){n(451)}}])):n():0>l&&9>d?(a=d+1,t.attr("data-slide-id",a),t.trigger("azbn.wheel",[{diff:l,next:a,callback:function(){n(451)}}])):n()}}))});
